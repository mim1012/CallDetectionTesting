...
public final class LayoutFloatingControlBinding implements ViewBinding {
  ...
  @NonNull
  public final ImageButton btnDebugPanel;
  ...
  private LayoutFloatingControlBinding(@NonNull FrameLayout rootView, @NonNull ImageButton btnClose,
      @NonNull ImageButton btnDebugPanel, @NonNull ImageButton btnStartDetection,
      @NonNull ImageButton btnStopDetection, @NonNull ImageButton btnTestClick,
      @NonNull ImageButton btnTestOcr, @NonNull ImageButton btnTestTemplate,
      @NonNull ImageButton collapsedView, @NonNull LinearLayout expandedView) {
    this.rootView = rootView;
    this.btnClose = btnClose;
    this.btnDebugPanel = btnDebugPanel;
  ...
  public static LayoutFloatingControlBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.btn_debug_panel;
      ImageButton btnDebugPanel = ViewBindings.findChildViewById(rootView, id);
      ...
      return new LayoutFloatingControlBinding((FrameLayout) rootView, btnClose, btnDebugPanel,
          btnStartDetection, btnStopDetection, btnTestClick, btnTestOcr, btnTestTemplate,
